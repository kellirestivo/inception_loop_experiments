...
from .natural_images_utils import process_all_units_natural_images, process_all_units_masked_images
...
__all__ = ['get_filename', 'process_mat_file', 'save_as_pickle', 
           ...
           'process_all_units_natural_images', 'process_all_units_masked_images'] 